# Script para  identificação de EDF's com ECG
...
np.save('ecg_train_seizure.npy',w.iloc[index_w,:].to_numpy())
np.save('ecg_train_n_seizure.npy',n.iloc[index_n,:].to_numpy())
